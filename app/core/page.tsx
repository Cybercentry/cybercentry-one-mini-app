        ...
        <div className={styles.content}>
          ...
          <div className={styles.detailsSection}>
            ...
            <ul className={styles.featuresList}>
              <li>Managed EDR (Endpoint Detection and Response)</li>
            ...
            <p className={styles.description}>
              Small businesses and startups looking for essential cybersecurity protection. The Core package provides
              fundamental security monitoring and threat detection to keep your organization safe from common cyber
              threats.
            </p>
            ...
            <ul className={styles.benefitsList}>
              ...
              <li>Continuous monitoring of your endpoints</li>
              <li>Regular vulnerability assessments</li>
              <li>Expert security team support</li>
              <li>Compliance-ready security posture</li>
            </ul>
          </div>
