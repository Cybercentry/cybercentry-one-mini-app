...
/**
 * Fully Farcaster MiniApp–compliant configuration object.
 * Internal fields are prefixed with an underscore to avoid schema rejection.
...
export const minikitConfig = {
  accountAssociation: {
    ...
    payload:
      'eyJkb21haW4iOiJjeWJlcmNlbnRyeS1vbmUtbWluaS1hcHAudmVyY2VsLmFwcCJ9',
    signature:
  ...
  /**
   * Internal configuration not part of the Farcaster MiniApp spec.
   * Safe to keep for deployment, build tooling, or custom logic.
   */
  _internal: {
    baseBuilder: {
